...
final class QMS_playRequestTests: XCTestCase {
    ...
    func testPlayALessonNotInTheQueue_QMS0121() async throws {
        ...
        storageMock.lectureWithIdReturnValue = LectureDataEntity(id: "6", title: "title 6", mediaURL: URL(string: "https://whatsup.com")!, queuePosition: nil, playPosition: nil)
        //       start the service:
        await qms_ut.start()
    ...
    private var finalDataLecturesForExistingLecture: [LectureDataEntity] {
        [
            ...
            LectureDataEntity(id: "1", title: "title 01", mediaURL: URL(string: "https://whatsup.com")!, queuePosition: 2, playPosition: nil),
            LectureDataEntity(id: "3", title: "title 03", mediaURL: URL(string: "https://whatsup.com")!, queuePosition: 3, playPosition: nil)
        ]
    }
    ...
    private var finalDataLecturesForNoneExistingLecture: [LectureDataEntity] {
        [
            LectureDataEntity(id: "6", title: "title 6", mediaURL: URL(string: "https://whatsup.com")!, queuePosition: 1, playPosition: nil),
            LectureDataEntity(id: "1", title: "title 01", mediaURL: URL(string: "https://whatsup.com")!, queuePosition: 2, playPosition: nil),
            LectureDataEntity(id: "2", title: "title 02", mediaURL: URL(string: "https://whatsup.com")!, queuePosition: 3, playPosition: nil),
            LectureDataEntity(id: "3", title: "title 03", mediaURL: URL(string: "https://whatsup.com")!, queuePosition: 4, playPosition: nil)
        ]
    }
}
