...
final class QueueManagementServiceProtocolMock: QueueManagementServiceProtocol {
    ...
    var skippedLectureIdReceivedId: String?
    var skippedLectureIdReceivedInvocations: [String] = []
    var skippedLectureIdClosure: ((String) -> Void)?
    ...
    var playLectureIdReceivedId: String?
    var playLectureIdReceivedInvocations: [String] = []
    var playLectureIdClosure: ((String) -> Void)?
